...
3. **Start from scratch** - A blank canvas to explore (skips prompt, goes directly to canvas)
...
## Random Project Name Generator (Dec 1, 2025)

### Overview

New projects now receive creative, memorable default names instead of "untitled". Names are generated by combining random adjectives and nouns (e.g., "Fuzzy Fish", "Golden Phoenix", "Misty Meadow").

### Implementation

#### Utility Module (`src/lib/projectNameGenerator.ts`)

Two exported functions:

- `generateProjectName(): string` - Generates a single random name
- `generateProjectNameSuggestions(count: number): string[]` - Generates multiple unique names

Word lists include 100 adjectives and 100 nouns (10,000 possible combinations):

**Adjectives** (100): Amber, Ancient, Atomic, Azure, Bold, Bouncy, Brave, Breezy, Bright, Bubbly, Calm, Charming, Cheerful, Clever, Coral, Cosmic, Cozy, Crimson, Crisp, Crystal, Curious, Dancing, Dapper, Daring, Dazzling, Distant, Dreamy, Dusty, Electric, Elegant, Emerald, Enchanted, Fancy, Fierce, Fluffy, Frosty, Fuzzy, Gentle, Gilded, Gleaming, Glowing, Golden, Gusty, Happy, Hazy, Hidden, Humble, Icy, Infinite, Jade, Jazzy, Jolly, Keen, Lively, Lucky, Luminous, Lunar, Magical, Marble, Mellow, Mighty, Misty, Mystic, Neon, Nimble, Noble, Painted, Peaceful, Peppy, Playful, Plucky, Polar, Puffy, Quiet, Radiant, Rosy, Rustic, Sandy, Secret, Shiny, Silky, Silver, Sleek, Snowy, Solar, Sparkling, Spicy, Starry, Stormy, Sunny, Swift, Tangy, Tender, Twilight, Velvet, Vibrant, Whimsy, Wild, Witty, Zesty

**Nouns** (100): Acorn, Anchor, Arrow, Aurora, Badger, Bear, Beacon, Birch, Blossom, Bluebird, Breeze, Brook, Butterfly, Canyon, Castle, Cedar, Cinder, Cloud, Clover, Comet, Compass, Coral, Cove, Crane, Cricket, Daisy, Dawn, Dewdrop, Dolphin, Dragon, Dragonfly, Dune, Echo, Ember, Falcon, Feather, Fern, Finch, Firefly, Forge, Fountain, Fox, Galaxy, Geyser, Glacier, Grove, Harbor, Heron, Honeybee, Horizon, Iris, Ivy, Kite, Lagoon, Lantern, Lark, Lighthouse, Lily, Lotus, Maple, Marigold, Meadow, Meteor, Moon, Moss, Mountain, Nebula, Oak, Oasis, Ocean, Orchid, Otter, Owl, Panther, Pebble, Pelican, Penguin, Phoenix, Pine, Poppy, Prism, Quill, Rainbow, Raven, Reef, River, Robin, Sage, Seashell, Sequoia, Snowflake, Sparrow, Storm, Sunflower, Sunset, Thistle, Tiger, Valley, Whale, Willow

### Integration

- `/new` page (`src/app/new/page.tsx`) now calls `generateProjectName()` instead of hardcoding "untitled"
- Users can still rename projects via the header inline edit feature
- Recent projects filters exclude "untitled" but now show randomly-named projects

### User Experience

- No more generic "untitled" projects cluttering the project list
- Each project starts with a memorable, fun name
- Names are designed to be kid-friendly and creative
- Users can immediately override the default by clicking the name in the header
